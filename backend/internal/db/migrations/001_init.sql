...
CREATE TABLE IF NOT EXISTS audit_logs (id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, event_type VARCHAR(64) NOT NULL, actor_admin_id BIGINT UNSIGNED NULL, ip_address VARCHAR(45) NOT NULL, details_json JSON NOT NULL, created_at DATETIME(6) NOT NULL, INDEX idx_audit_event_time(event_type,created_at)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
